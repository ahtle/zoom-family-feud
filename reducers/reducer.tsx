...
export const AppReducer = (state, action) => {
    switch (action.type) {
        ...
        case "START_GAME": {
            ...
            const questionsIndex = action.payload.questions.map((item) => {
                return item.id;
            });
            ...
            return {
                ...
                questions_seen: [...state.questions_seen, ...questionsIndex],
                phase: "HEADS_UP_INFO",
            };
        }
        case "HEADS_UP": {
        ...
        case "HEADS_UP_ANSWERED_FIRST": {
            return {
                ...state,
                teamTurn: action.payload,
                phase: "HEADS_UP_ANSWERED_FIRST",
            };
        }
        case "HEADS_UP_WRONG": {
        ...
        case "STEAL_PROCESS_ANSWER": {
            ...
            if (
                answeredNames.length ===
                state.questions[state.questionIndex].answers.length
            ) {
        ...
        case "PROCESS_ANSWER": {
            ...
            if (
                ...
                if (
                    teams[state.teamTurn].members.length ===
                    teams[state.teamTurn].member_turn + 1
                ) {
        ...
        case "START_NEXT_ROUND": {
            ...
            teams[1].points = 0;
            if (
                teams[teamTurn].members.length ===
                teams[teamTurn].member_turn + 1
            ) {
            ...
            return {
                ...
                answeredWrongCount: 0,
                answeredNames: [],
                phase: "WAIT_FOR_ANSWER",
            };
        }
        case "RESTART": {
            const questions_seen = [...state.questions_seen];
            return { ...initialState, questions_seen };
        }
